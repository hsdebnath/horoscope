...
@section('content')
    ...
    <header class="masthead bg-default text-white text-center page-section portfolio" id="portfolio">
        ...
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Zodiac Calender <span class="text-warning">{{$Dates[0]->year}}</span></h2>                
            <!-- Icon Divider-->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="portfolio-item mx-4" data-bs-toggle="modal" data-bs-target="#modal-{{$zodizc['id']}}">
                        <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100 px-5">
    ...
    <!-- Contact Section-->
    <section class="page-section mb- p-0" id="about">
        <div class="container">
            <!-- Contact Section Heading-->
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">In {{$Dates[0]->year}} <span class="text-success">{{$best_year }}'s</span> are the luckiest </h2>
            <!-- Icon Divider-->
            <div class="divider-custom">
                <div class="divider-custom-line"></div>
                <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
